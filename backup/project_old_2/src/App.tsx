...
import { formatId, getRentalStatus, formatDate, maskLastName, maskPhoneNumber, maskUserId } from './utils';
import { UserIdTooltip } from './components/UserIdTooltip';
        ...
        {bookings.map((booking) => (
          <tr key={booking.id} className="hover:bg-purple-50 dark:hover:bg-purple-900/10 transition-colors">
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
              <UserIdTooltip userId={booking.userId}>
                {maskUserId(booking.userId)}
              </UserIdTooltip>
            </td>
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
              {`${booking.firstName} ${maskLastName(booking.lastName)}`}
            </td>
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
              {maskPhoneNumber(booking.phoneNumber)}
            </td>
